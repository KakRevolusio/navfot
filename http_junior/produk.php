        ...
        <div class="col">
            <div class="card-columns-fluid">
                <div class="card bg-light" style = "" >
                    <div class="card-body">
                        <h5 class="card-title"><b><?php echo $elements["name"] ?></b></h5>
                        <p class="card-text"><b><?php echo $elements["desc"] ?></b></p>
                        <p class="card-text"><?php echo $elements["price"] ?></p>
                        <p class="card-text"><?php echo $elements["id"] ?></p>
